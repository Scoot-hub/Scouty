...
const content = {
  fr: {
    ...
    art2_5_title: "2.5 Donnees issues de l'import de fichiers de statistiques",
    art2_5_p: "Les Utilisateurs disposant du role importateur peuvent importer des fichiers Excel de statistiques de joueurs. Ces donnees statistiques (jusqu'a 130 colonnes par joueur : buts, passes, distance parcourue, etc.) sont stockees dans une table dediee aux statistiques et sont liees aux fiches joueurs existantes ou nouvellement creees. Ces donnees sont traitees et stockees exclusivement sur les serveurs de la plateforme et ne sont pas transmises a des tiers.",
    ...
    art3_rows: [
      ...
      ['Import de donnees statistiques', 'Execution du contrat'],
  ...
  en: {
    ...
    art2_5_title: '2.5 Data from statistics file imports',
    art2_5_p: 'Users with the importer role can upload Excel files containing player statistics. These statistical data points (up to 130 columns per player: goals, assists, distance covered, etc.) are stored in a dedicated statistics table and linked to existing or newly created player profiles. This data is processed and stored exclusively on the platform\'s servers and is not shared with third parties.',
    ...
    art3_rows: [
      ...
      ['Statistical data import', 'Performance of the contract'],
  ...
  es: {
    ...
    art2_5_title: '2.5 Datos procedentes de la importacion de archivos de estadisticas',
    art2_5_p: 'Los Usuarios con el rol de importador pueden importar archivos Excel con estadisticas de jugadores. Estos datos estadisticos (hasta 130 columnas por jugador: goles, asistencias, distancia recorrida, etc.) se almacenan en una tabla dedicada a las estadisticas y se vinculan a los perfiles de jugadores existentes o recien creados. Estos datos se procesan y almacenan exclusivamente en los servidores de la plataforma y no se comparten con terceros.',
    ...
    art3_rows: [
      ...
      ['Importacion de datos estadisticos', 'Ejecucion del contrato'],
  ...
  de: {
    ...
    effective: 'Gültig ab 5. Mai 2026',
    art1_title: 'Artikel 1 — Verantwortlicher',
    art1_p1: 'Der Verantwortliche für die Verarbeitung personenbezogener Daten, die über die Plattform Scouty (scouty.app) erhoben werden, ist:',
    art1_items: [
      '<strong>Scouty</strong>, Dienst herausgegeben von der Gesellschaft [Firmenname zu ergänzen], [Rechtsform], mit einem Kapital von [Betrag] Euro',
      'Eingetragen im Handelsregister von [Stadt] unter der Nummer [Nummer]',
      'Sitz: [Adresse]',
    ],
    art1_email_label: 'Kontakt-E-Mail',
    art1_p2: 'Der Herausgeber handelt als Verantwortlicher für die Nutzerdaten (Konto, Profil, Einstellungen) und als Auftragsverarbeiter für die vom Nutzer eingegebenen Spielerdaten.',
    art2_title: 'Artikel 2 — Erhobene Daten',
    art2_1_title: '2.1 Direkt vom Nutzer bereitgestellte Daten',
    art2_1_items: [
      { label: 'Identifikationsdaten', desc: 'Name, Vorname, E-Mail-Adresse' },
      { label: 'Berufsdaten', desc: 'Name des Vereins/der Organisation, berufliche Funktion (Scout, Recruiter, Trainer, Agent)' },
      { label: 'Authentifizierungsdaten', desc: 'Passwort (als bcrypt-Hash gespeichert, niemals im Klartext)' },
      { label: 'Scouting-Daten', desc: 'Spielerprofile, Beobachtungsberichte, Notizen, Bewertungen, Beobachtungslisten, Wunschelfen' },
      { label: 'Finanzdaten', desc: 'Ausschließlich von Stripe verarbeitet (PCI-DSS); keine Bankdaten auf unseren Servern gespeichert' },
    ],
    art2_2_title: '2.2 Automatisch erhobene Daten',
    art2_2_items: [
      { label: 'Technische Daten', desc: 'IP-Adresse, Browsertyp und -version, Betriebssystem, Bildschirmauflösung' },
      { label: 'Verbindungsdaten', desc: 'Datum und Uhrzeit der Anmeldung, besuchte Seiten, Sitzungsdauer' },
      { label: 'Unbedingt notwendige Cookies', desc: 'Authentifizierungssitzung, Sprach- und Theme-Einstellungen' },
    ],
    art2_3_title: '2.3 Daten aus automatischer Anreicherung',
    art2_3_p: 'Für Nutzer, die die Anreicherung aktiviert haben, werden Spielerdaten (Foto, Marktwert, Karrierestatistiken) aus öffentlichen Quellen (Transfermarkt, TheSportsDB, API-Football, Wikidata) erhoben und im Konto des Nutzers gespeichert.',
    art2_4_title: '2.4 Daten aus optionalen Drittanbieter-Integrationen',
    art2_4_p: 'Der Nutzer kann optionale Integrationsmodule durch Eingabe seiner eigenen API-Schlüssel konfigurieren. Diese Schlüssel werden verschlüsselt in der Tabelle user_integrations gespeichert.',
    art2_4_items: [
      { label: 'Perplexity AI', desc: 'Textuelle Anreicherung von Spielerprofilen mittels KI (wenn API-Schlüssel angegeben)' },
      { label: 'Pappers', desc: 'Unternehmens- und Sportberaterdaten (wenn API-Schlüssel angegeben)' },
      { label: 'Drop Contact', desc: 'Anreicherung und Überprüfung professioneller Kontakte (wenn API-Schlüssel angegeben)' },
    ...
    art2_7_p: 'Bestimmte Schnittstelleneinstellungen (Entfernungseinheit km/Meilen, Wochenstartag, Anzeige eingeschränkter Elemente, automatische Abmeldung) werden ausschließlich im localStorage des Browsers unter dem Schlüssel scouthub-ui-preferences gespeichert und niemals an unsere Server übertragen.',
    art2_8_title: '2.8 Geolokalisierungsdaten',
    art2_8_p: 'Die Funktion „Weltkarte – In meiner Nähe" verwendet die Geolocation API des Browsers, um die Karte auf den Standort des Nutzers zu zentrieren. Dieser Standort wird ausschließlich im lokalen Speicher des Browsers verwendet und niemals an unsere Server übermittelt.',
    art3_title: 'Artikel 3 — Zwecke und Rechtsgrundlagen',
    art3_headers: ['Zweck', 'Rechtsgrundlage'],
    art3_rows: [
      ['Kontoerstellung und -verwaltung', 'Vertragserfüllung (Nutzungsbedingungen)'],
      ['Bereitstellung des Scouting-Dienstes', 'Vertragserfüllung'],
      ['Zahlungsabwicklung und Rechnungsstellung', 'Vertragserfüllung'],
      ['Versand von Dienstbenachrichtigungen', 'Berechtigtes Interesse'],
      ['Serviceverbesserung und Fehlerbehebung', 'Berechtigtes Interesse'],
      ['Anonyme Analysen (Vercel Analytics)', 'Berechtigtes Interesse'],
    ...
    art4_title: 'Artikel 4 — Aufbewahrungsfristen',
    art4_items: [
      { label: 'Konto- und Scouting-Daten', desc: 'Aufbewahrung für maximal 5 Jahre ab der letzten Kontoaktivität. Löschung innerhalb von 30 Tagen nach Antrag auf Kontolöschung.' },
      { label: 'Rechnungsdaten', desc: 'Aufbewahrung für 10 Jahre gemäß den französischen Buchführungs- und Steuerpflichten.' },
      { label: 'Verbindungsprotokolle', desc: 'Aufbewahrung für 12 Monate gemäß den geltenden Rechtsvorschriften.' },
      { label: 'Passwort-Reset-Tokens', desc: 'Ablauf und Löschung nach 1 Stunde.' },
      { label: 'Inaktive Konten', desc: 'Konten, die seit mehr als 24 Monaten inaktiv sind, können nach E-Mail-Benachrichtigung gelöscht werden.' },
    ],
    art5_title: 'Artikel 5 — Empfänger und Auftragsverarbeiter',
    art5_p1: 'Ihre personenbezogenen Daten werden von den folgenden Auftragsverarbeitern ausschließlich im Rahmen der Dienstleistungserbringung verarbeitet:',
    art5_headers: ['Auftragsverarbeiter', 'Zweck', 'Standort'],
    art5_rows: [
      ['TiDB Cloud (PingCAP)', 'Datenbank-Hosting', 'EU (Frankfurt)'],
      ['Vercel Inc.', 'Anwendungs-Hosting und anonyme Analysen', 'USA (Standardvertragsklauseln)'],
      ['Stripe Inc.', 'Zahlungsabwicklung', 'USA (PCI-DSS-zertifiziert, Standardvertragsklauseln)'],
      ['Brevo (Sendinblue)', 'Transaktionale E-Mail-Zustellung', 'EU (Paris, Frankreich)'],
      ['API-Football (RapidAPI)', 'Spieldaten und Statistiken', 'EU'],
      ['Wikidata (Wikimedia Foundation)', 'Vereinsprofilanreicherung (öffentliche Daten)', 'Weltweit (offene Daten)'],
      ['TheSportsDB', 'Trainerprofile und öffentliche Sportdaten', 'International'],
      ['Transfermarkt', 'Marktwerte und Karrieredaten (öffentliche Daten)', 'EU (Deutschland)'],
      ['Perplexity AI (falls konfiguriert)', 'KI-gestützte Spielerprofilanreicherung', 'USA (falls vom Nutzer aktiviert)'],
      ['Pappers (falls konfiguriert)', 'Unternehmens- und Direktordaten', 'EU (Frankreich, falls aktiviert)'],
      ['Drop Contact (falls konfiguriert)', 'Anreicherung professioneller Kontakte', 'EU (Frankreich, falls aktiviert)'],
      ['SocialData (falls konfiguriert)', 'Daten aus öffentlichen sozialen Netzwerken', 'International (falls aktiviert)'],
    ],
    art5_p2: 'Keine personenbezogenen Daten werden verkauft oder vermietet. Daten werden nur an die oben aufgeführten Auftragsverarbeiter im Rahmen von Verträgen gemäß Artikel 28 DSGVO weitergegeben.',
    art6_title: 'Artikel 6 — Datenübermittlungen außerhalb der EU',
    art6_p: 'Einige unserer Auftragsverarbeiter (Vercel, Stripe) haben ihren Sitz in den USA. Diese Übermittlungen werden geregelt durch:',
    art6_items: [
      '<strong>Standardvertragsklauseln (SCC)</strong>, die von der Europäischen Kommission verabschiedet wurden (Beschluss 2021/914)',
      'Zusätzliche technische <strong>Sicherheitsmaßnahmen</strong> (Verschlüsselung, Pseudonymisierung)',
      'Für Stripe: <strong>PCI-DSS</strong>-Konformität und den <strong>EU-US-Datenschutzrahmen</strong>',
    ],
    art7_title: 'Artikel 7 — Ihre Rechte',
    art7_p: 'Gemäß der DSGVO (Artikel 15 bis 22) haben Sie folgende Rechte:',
    art7_rights: [
      { label: 'Auskunftsrecht', art: 'Art. 15', desc: 'Bestätigung erhalten, dass Ihre Daten verarbeitet werden, und eine Kopie erhalten' },
      { label: 'Recht auf Berichtigung', art: 'Art. 16', desc: 'Unrichtige oder unvollständige Daten korrigieren' },
      { label: 'Recht auf Löschung / Recht auf Vergessenwerden', art: 'Art. 17', desc: 'Löschung Ihrer Daten beantragen' },
      { label: 'Recht auf Einschränkung', art: 'Art. 18', desc: 'Die Verarbeitung Ihrer Daten einschränken' },
      { label: 'Recht auf Datenübertragbarkeit', art: 'Art. 20', desc: 'Ihre Daten in einem strukturierten Format erhalten' },
      { label: 'Widerspruchsrecht', art: 'Art. 21', desc: 'Der Verarbeitung Ihrer Daten widersprechen' },
      { label: 'Recht auf Widerruf der Einwilligung', art: 'Art. 7', desc: 'Jederzeit, ohne die Rechtmäßigkeit der vor dem Widerruf erfolgten Verarbeitung zu berühren' },
      { label: 'Recht auf Festlegung von Anweisungen für die Zeit nach dem Tod', art: '', desc: 'Bezüglich der Aufbewahrung, Löschung oder Weitergabe Ihrer Daten nach Ihrem Tod' },
    ],
    art7_delete_link: 'Direkt ausübbar auf Ihrer',
    art7_account_page: 'Kontoseite',
    art7_delete_button: '(Schaltfläche „Konto löschen")',
    art7_export_button: '(Schaltfläche „Meine Daten exportieren")',
    art7_how_title: 'Wie Sie Ihre Rechte ausüben können',
    art7_self_service: 'Selbstverwaltung',
    art7_self_service_desc: 'auf Ihrer',
    art7_self_service_details: '(Datenexport, Kontolöschung)',
    art7_by_email: 'Per E-Mail',
    art7_response: 'Wir verpflichten uns, innerhalb von 30 Tagen zu antworten. Ein Identitätsnachweis kann zur Überprüfung angefordert werden.',
    art7_complaint_title: 'Beschwerde bei der Aufsichtsbehörde',
    art7_complaint_p: 'Wenn Sie der Ansicht sind, dass Ihre Rechte nicht gewahrt werden, können Sie eine Beschwerde beim Bundesbeauftragten für den Datenschutz und die Informationsfreiheit (BfDI) oder bei der CNIL einreichen:',
    art7_complaint_online: 'Online',
    art7_complaint_mail: 'Per Post: CNIL, 3 Place de Fontenoy, TSA 80715, 75334 Paris Cedex 07',
    art8_title: 'Artikel 8 — Cookies und Tracker',
    art8_1_title: '8.1 Verwendete Cookies',
    art8_cookie_headers: ['Cookie', 'Zweck', 'Dauer', 'Typ'],
    art8_cookies: [
      ['scouthub_session', 'Authentifizierung und Sitzungsaufrechterhaltung', 'Sitzung', 'Unbedingt notwendig'],
      ['scouthub-lang', 'Sprachpräferenz', 'Dauerhaft', 'Unbedingt notwendig'],
      ['theme', 'Theme-Präferenz (hell/dunkel)', 'Dauerhaft', 'Unbedingt notwendig'],
      ['scouthub-ui-preferences', 'Schnittstelleneinstellungen (Entfernungseinheit, Sidebar-Ansicht, Auto-Abmeldung)', 'Dauerhaft', 'Unbedingt notwendig'],
    ],
    art8_2_title: '8.2 Was wir NICHT verwenden',
    art8_2_items: [
      'Keine Werbe-Cookies',
      'Keine Drittanbieter-Tracking-Cookies (Google Analytics, Facebook Pixel usw.)',
      'Keine Retargeting-Tools',
    ],
    art8_3_title: '8.3 Analysen',
    art8_3_p: 'Scouty verwendet Vercel Analytics für anonyme Leistungsmetriken (Ladezeiten, Fehler). Dieses Tool setzt keine Cookies und erfasst keine personenbezogenen Daten.',
    art8_4_title: '8.4 Rechtsgrundlage',
    art8_4_p: 'Gemäß der ePrivacy-Richtlinie (2002/58/EG) und den CNIL-Leitlinien sind für den Betrieb des Dienstes unbedingt notwendige Cookies von der vorherigen Zustimmung ausgenommen. Da Scouty ausschließlich notwendige Cookies verwendet, ist keine vorherige Zustimmung erforderlich.',
    art9_title: 'Artikel 9 — Datensicherheit',
    art9_p: 'Scouty implementiert folgende Sicherheitsmaßnahmen basierend auf dem ISO/IEC 27001-Rahmenwerk:',
    art9_items: [
      { label: 'Verschlüsselung bei der Übertragung', desc: 'TLS 1.3 für alle Kommunikationen' },
      { label: 'Verschlüsselung im Ruhezustand', desc: 'AES-256 für gespeicherte Daten' },
      { label: 'Passwort-Hashing', desc: 'bcrypt-Algorithmus mit einzigartigem Salt' },
      { label: 'Datenisolierung', desc: 'Jeder Nutzer kann nur auf seine eigenen Daten zugreifen (Row Level Security)' },
      { label: 'Verstärkte Authentifizierung', desc: '2FA-Unterstützung (TOTP und E-Mail)' },
      { label: 'Sicherungen', desc: 'Automatische tägliche Datenbanksicherungen' },
      { label: 'Überwachung', desc: 'Zugriffsprotokollierung und Anomalieerkennung' },
      { label: 'Aktualisierungen', desc: 'Regelmäßige Anwendung von Sicherheitspatches' },
    ],
    art10_title: 'Artikel 10 — Datenpanne',
    art10_p: 'Im Falle einer Verletzung des Schutzes personenbezogener Daten:',
    art10_items: [
      'Der Herausgeber benachrichtigt den <strong>BfDI/CNIL</strong> innerhalb von <strong>72 Stunden</strong> gemäß Artikel 33 DSGVO',
      'Betroffene Nutzer werden <strong>so schnell wie möglich</strong> informiert, wenn die Verletzung voraussichtlich ein hohes Risiko für ihre Rechte und Freiheiten mit sich bringt (Artikel 34 DSGVO)',
      'Korrekturmaßnahmen werden sofort ergriffen und dokumentiert',
    ],
    art11_title: 'Artikel 11 — Daten von Minderjährigen',
    art11_p: 'Die Plattform ist für den professionellen Einsatz bestimmt. Die Registrierung ist Personen ab 16 Jahren vorbehalten. Sollten wir feststellen, dass Daten eines Minderjährigen unter 16 Jahren ohne die erforderliche elterliche Einwilligung erhoben wurden, werden wir diese unverzüglich löschen.',
    art12_title: 'Artikel 12 — Änderungen der Richtlinie',
    art12_p1: 'Diese Richtlinie kann jederzeit geändert werden. Wesentliche Änderungen werden mindestens 30 Tage vor Inkrafttreten per E-Mail und/oder durch eine Benachrichtigung auf der Plattform mitgeteilt.',
    art12_p2: 'Das Datum der letzten Aktualisierung ist oben auf dieser Seite angegeben.',
    art13_title: 'Artikel 13 — Kontakt',
    art13_p: 'Bei Fragen zum Schutz Ihrer personenbezogenen Daten:',
    art13_dpo: 'Datenschutzbeauftragter (DSB)',
    art13_support: 'Allgemeiner Support',
    footer: 'Diese Datenschutzrichtlinie ist jederzeit verfügbar unter',
  },
};
