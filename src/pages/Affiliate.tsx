...
import { Gift, Copy, Users, Euro, TrendingUp, CheckCircle2, ArrowRight, Sparkles, Share2, Crown } from 'lucide-react';
...
export default function Affiliate() {
  ...
  const stats = [
    { label: t('affiliate.stat_referrals'), value: '0', icon: Users },
    { label: t('affiliate.stat_active'), value: '0', icon: CheckCircle2 },
    { label: t('affiliate.stat_earnings'), value: '0,00 €', icon: Euro },
    { label: t('affiliate.stat_conversion'), value: '—', icon: TrendingUp },
  ];
